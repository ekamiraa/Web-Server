            ...
            foreach ($data as $r) {
              ...
              <div class="col mt-4">
                <div class="card h-100">
                  <img src="<?= $r->images ?>" class="card-img-top" alt="Product images">
                  <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">
                        <a href="ubah_produk.php?id_produk=<?= $r->id_produk ?>" class="btn btn-success btn-sm"
                          type="button" name="update_produk_btn">Update</a>
                        <td>
                          <a href="#" class="btn btn-danger btn-sm" data-toggle="modal"
                            data-target="#deleteModal<?= $r->id_produk ?>">
                            Delete
                          </a>
                        </td>
                        <!-- Delete Modal -->
                        <div class="modal fade" id="deleteModal<?= $r->id_produk ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-danger"
                                  href="proses_produk.php?aksi=hapus_produk&id_produk=<?= $r->id_produk ?>">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
