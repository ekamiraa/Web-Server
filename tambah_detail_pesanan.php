          ...
          <div class="p-5">
            ...
            <form class="user" action="proses_detail_pesanan.php" method="POST">
              ...
              <div class="form-group">
                <input type="hidden" name="aksi" value="tambah_detail" />
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" id="jumlah_produk" placeholder="Jumlah Produk"
                  name="jumlah_produk">
              </div>

              <div class="form-group">
                <label for="subtotal">Total</label>
                <input type="text" class="form-control form-control-user" id="subtotal" placeholder="subtotal"
                  name="subtotal">
              </div>
