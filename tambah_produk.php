        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          <div class="p-5">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-4">Masukkan Data Produk!</h1>
            </div>


            <form class="user" action="proses_produk.php" method="POST">
              ...
              <div class="form-group">
                <input type="text" class="form-control form-control-user" id="images" placeholder="images"
                  name="images">
              </div>
