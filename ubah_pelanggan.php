      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          <div class="p-5">
            ...
            <?php
            $r = $abc->tampilDataPelanggan($_GET['id_pelanggan']);
            ?>
            <form class="user" action="proses_pelanggan.php" method="POST" name="form">
