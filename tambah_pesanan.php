          ...
          <div class="p-5">
            ...
            <form class="user" action="proses_pesanan.php" method="POST">
              ...
              <div class="form-group">
                <input type="hidden" name="aksi" value="tambah_pesanan" />
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="id_pelanggan" name="id_pelanggan">
                  ...
                  foreach ($data as $r) {
                    echo '<option value="' . $r->id_pelanggan . '">' . $r->nama_depan . '</option>';
                  }
                  ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" id="tanggal_pesanan"
                  placeholder="Tanggal Pesanan" name="tanggal_pesanan">
              </div>

              <div class="form-group">
                <label for="jumlah">Jumlah</label>
                <input type="text" class="form-control form-control-user" id="jumlah" placeholder="Jumlah"
                  name="jumlah">
              </div>
